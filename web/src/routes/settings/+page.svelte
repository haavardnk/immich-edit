    ...
    <section class="space-y-2">
      ...
      {:else}
        <div class="rounded border border-amber-500/30 bg-amber-500/5 p-3 space-y-2 text-xs">
          ...
          <div class="flex items-center gap-2">
            <button
              class="px-2 py-1 rounded {rebindMethod === 'password'
                ? 'bg-white/15'
                : 'bg-white/5 hover:bg-white/10'}"
            ...
            <button
              class="px-2 py-1 rounded {rebindMethod === 'apikey'
                ? 'bg-white/15'
                : 'bg-white/5 hover:bg-white/10'}"
          ...
          <p class="text-immich-dark-fg/50">
            ...
            {#if rebindHostname(rebindUrl)}<span class="font-mono">{rebindHostname(rebindUrl)}</span
              >{/if}
            to confirm.
          </p>
          <input
