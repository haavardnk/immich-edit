...
| Multi-select and batch actions | ✓ Yes | Whole-filter selection enables jobs; **Select loaded** enables metadata, culling, tags, and virtual copies; **Edit and export selected** opens copy, preset, and export controls |
